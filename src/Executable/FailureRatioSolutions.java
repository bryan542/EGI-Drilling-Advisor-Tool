...
public class FailureRatioSolutions extends DrillingEquations {
    ...
    public DefaultCategoryDataset principalStresses(double sigmaVGradient, double sigmahGradient, double sigmaHGradientInitial, double depth, double mudweight, double alpha, double gamma, double poisson, double porePressureGradient, String GSI, String Lithology, double D, String returnParam){
        ...
        for (double i = initialRange;i< finalRange;i += incrimentRange){
            ...
            if (mudweight >porePressureGradient){
                ...
                sigma1 = DrillingEquations.sigma3(sigmaR);
                sigma2 = DrillingEquations.sigma2(sigmaTheta,sigmaZ,thoThetaZ);
                sigma3 = DrillingEquations.sigma1(sigmaTheta,sigmaZ,thoThetaZ);
            }
            else{

                sigma1 = DrillingEquations.sigma2(sigmaTheta,sigmaZ,thoThetaZ);
                sigma2 = DrillingEquations.sigma1(sigmaTheta,sigmaZ,thoThetaZ);
                sigma3 = DrillingEquations.sigma3(sigmaR);
            }
            ...
            double compressiveStrengthIntact = rockPropertyGSISolver(sortedEffectiveStresses[2],sortedEffectiveStresses[1],sortedEffectiveStresses[0],GSI,Lithology,D,sigmaVGradient,"Compressive Strength Intact");
            double compressiveStrength = rockPropertyGSISolver(sortedEffectiveStresses[2],sortedEffectiveStresses[1],sortedEffectiveStresses[0],GSI,Lithology,D,sigmaVGradient,"Compressive Strength");
            double tensileStrength = -1*rockPropertyGSISolver(sortedEffectiveStresses[2],sortedEffectiveStresses[1],sortedEffectiveStresses[0],GSI,Lithology,D,sigmaVGradient,"Tensile Strength");
            double cohesion = rockPropertyGSISolver(sortedEffectiveStresses[2],sortedEffectiveStresses[1],sortedEffectiveStresses[0],GSI,Lithology,D,sigmaVGradient,"Cohesion");
            double coeffFriction = rockPropertyGSISolver(sortedEffectiveStresses[2],sortedEffectiveStresses[1],sortedEffectiveStresses[0],GSI,Lithology,D,sigmaVGradient,"CoeffFriction");
            double shearStrength = rockPropertyGSISolver(sortedEffectiveStresses[2],sortedEffectiveStresses[1],sortedEffectiveStresses[0],GSI,Lithology,D,sigmaVGradient,"Shear Strength");
